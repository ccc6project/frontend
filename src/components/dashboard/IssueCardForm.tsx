// components/dashboard/IssueCardForm.tsx
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 border border-blue-100 max-w-2xl mx-auto">
        ...
        <div className="text-center py-4">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Para emitir una tarjeta AMEX, primero necesitas vincular una cuenta bancaria
          </p>
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-500">
              Ve a "Agregar Cuenta Bancaria" en el dashboard principal
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-red-50 border border-red-200 text-red-800 p-4 rounded-lg mb-6">
          <div className="flex items-start">
            ...
            <div>
              ...
              {error.includes('No valid bank account') && (
                <p className="text-sm mt-1">
                  💡 Asegúrate de seleccionar una cuenta bancaria válida y que esté activa.
                </p>
              )}
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mb-4">
            Elige la cuenta bancaria que quieres vincular a tu nueva tarjeta AMEX
          </p>
            ...
            <div className="flex gap-4 pt-4">
              ...
              >
                {isLoading ? (
                  ...
                  'Aceptar Oferta y Emitir Tarjeta'
                )}
              </Button>
            </div>
          </form>
